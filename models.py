...
from sqlalchemy import Float, Column, Numeric, String, Integer, DECIMAL
...
class Trail_Point(db.Model):
    __tablename__ = 'Trail_Point'
    __table_args__ = {'schema': 'CW2'}

    trail_point_id = db.Column(db.String(8), primary_key=True)
    trail_id = db.Column(db.String(7), db.ForeignKey('CW2.Trail.trail_id'), nullable=False)
...
class TrailPointSchema(Schema):
    trail_point_id = fields.Str(dump_only=True)
    ...
    sequence_no = fields.Int(required=True, validate=validate.Range(min=1))
